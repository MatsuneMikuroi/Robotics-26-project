...
class ObjectIsGreen:
    ...
    def follow_line_reverse(self):
        ...
        if middle_on_line and not right_on_line and not left_on_line:
    ...
    def follow_line_reverse3(self):
        ...
        if left_on_line and middle_on_line and not right_on_line:
            ...
            self.robot.set_speed(BASE_SPEED, TURN_SPEED)
    ...
    def follow_line_home(self):
        ...
        elif not right_on_line and middle_on_line and left_on_line:
    ...
    def ReachGrabArea(self):
        ...
        while self.robot.go_on():
            ...
            # ========================================
                ...
                if time.time() - self.small_forward_start > 0.6:
